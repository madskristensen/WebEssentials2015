...
namespace MadsKristensen.EditorExtensions.Html
{
    ...
    {
        private static BitmapFrame _icon = BitmapFrame.Create(new Uri("pack://application:,,,/WebEssentials2015;component/Resources/Images/bootstrap.png", UriKind.RelativeOrAbsolute));

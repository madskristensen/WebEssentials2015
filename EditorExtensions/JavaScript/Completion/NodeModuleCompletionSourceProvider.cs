...
namespace MadsKristensen.EditorExtensions.JavaScript
{
	...
	public class NodeModuleCompletionSource : ICompletionSource
	{
		...
		static ImageSource moduleIcon = BitmapFrame.Create(new Uri("pack://application:,,,/WebEssentials2015;component/Resources/Images/node_module.png", UriKind.RelativeOrAbsolute));
		...
		{
			{ ".js",    BitmapFrame.Create(new Uri("pack://application:,,,/WebEssentials2015;component/Resources/Images/jsfile.png", UriKind.RelativeOrAbsolute)) },

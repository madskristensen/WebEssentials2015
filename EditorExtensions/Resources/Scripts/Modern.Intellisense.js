...
var require = function (module) {
    ...
    return {
        task: function () {
            /// <signature>
            ///   <summary>Registers a Gulp task.</summary>
            ///   <param name="name" type="string">The name of the task. Tasks that you want to run from the command line should not have spaces in them.</param>
            ///   <param name="fn" type="function">The function that performs the task's operations. Generally this takes the form of 'gulp.src().pipe(someplugin())'.</param>
            /// </signature>
            /// <signature>
            ///   <summary>Registers a Gulp task.</summary>
            ///   <param name="name" type="string">The name of the task. Tasks that you want to run from the command line should not have spaces in them.</param>
            ///   <param name="deps" type="Array">An array of tasks to be executed and completed before your task will run.</param>
            /// </signature>
            /// <signature>
            ///   <summary>Registers a Gulp task.</summary>
            ///   <param name="name" type="string">The name of the task. Tasks that you want to run from the command line should not have spaces in them.</param>
        ...
        src: function () {
            /// <signature>
            ///   <summary>Emits files matching provided glob or an array of globs.</summary>
            ///   <param name="name" type="string">Glob to read.</param>
            /// </signature>
            /// <signature>
            ///   <summary>Emits files matching provided glob or an array of globs.</summary>
            ///   <param name="name" type="Array">Array of globs to read.</param>
            /// </signature>
            return this;
        },
        dest: function () {
            /// <signature>
            ///   <summary>Can be piped to and it will write files. Re-emits all data passed to it so you can pipe to multiple folders. Folders that don't exist will be created.</summary>
            ///   <param name="name" type="string">Glob to read.</param>
            /// </signature>
            /// <signature>
            ///   <summary>Can be piped to and it will write files. Re-emits all data passed to it so you can pipe to multiple folders. Folders that don't exist will be created.</summary>
        ...
        path: function () {
            /// <signature>
            ///   <summary>The path (output folder) to write files to.</summary>
            ///   <param name="name" type="string">Globbing pattern.</param>
            /// </signature>
            /// <signature>
            ///   <summary>A function that returns a output folder path.</summary>
            ///   <param name="name" type="Function"></param>
            /// </signature>
            return this;
        },
        pipe: function () {
            /// <signature>
            ///   <summary></summary>
            ///   <param name="fn" type="function">A function to execute.</param>
            /// </signature>
            return this;
        },
        /// <field name="options" type="Object">Options to pass to node-glob through glob-stream.</field>
        options: {
            /// <field name="buffer" type="Boolean">Setting this to  false  will return  file.contents  as a stream and not buffer files. This is useful when working with large files. Note: Plugins might not implement support for streams.</field>
            buffer: true,
            /// <field name="read" type="Boolean">Setting this to  false  will return  file.contents  as null and not read the file at all.</field>
            read: true,
            /// <field name="base" type="String"></field>
            base: ""
        },
        watch: function () {
            /// <signature>
            ...
            ///   <param name="glob" type="string">A single glob that indicate which file to watch for changes.</param>
            ///   <param name="opts" type="Object">Options, that are passed to 'gaze'.</param>
            ///   <param name="tasks" type="Array">Names of task(s) to run when a file changes, added with 'gulp.task()'.</param>
            /// </signature>
            /// <signature>
            ///   <summary>Watch files and do something when a file changes. This always returns an EventEmitter that emits  change  events.</summary>
            ...
            ///   <summary>Watch files and do something when a file changes. This always returns an EventEmitter that emits  change  events.</summary>
            ///   <param name="glob" type="string">A single glob that indicate which file to watch for changes.</param>
            ///   <param name="cb" type="function">Callback to be called on each change.</param>
            /// </signature>
            /// <signature>
            ///   <summary>Watch files and do something when a file changes. This always returns an EventEmitter that emits  change  events.</summary>
            ///   <param name="glob" type="Array">An array of globs that indicate which files to watch for changes.</param>

...
namespace MadsKristensen.EditorExtensions.Markdown
{
    ...
    class CodeBlockBlockHandler : ArtifactBasedBlockHandler
    {
        ...
        {
            return new ArtifactBasedBufferGenerator(EditorTree, LanguageBlocks, contentTypeRegistry.GetContentType("text"));
        }
        ...
        protected override void BuildLanguageBlockCollection()
        {
            ...
            {
                var contentType = contentTypeRegistry.GetContentType("code");
